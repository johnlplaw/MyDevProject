...
model_1 = "mBERT_Mul_1200"
model_1_acc_t, model_1_acc_e = lib.get_model_list("mBERT_Multilingual_1200_ori_RO3_Batch_8")

model_2 = "mBERT_Mul_1600"
model_2_acc_t, model_2_acc_e = lib.get_model_list("mBERT_Multilingual_1600_ori_RO3_Batch_8")

model_3 = "mBERT_Mul_2000"
model_3_acc_t, model_3_acc_e = lib.get_model_list("mBERT_Multilingual_2000_ori_RO3_Batch_8")

model_4 = "mBERT_Mul_2400"
model_4_acc_t, model_4_acc_e = lib.get_model_list("mBERT_Multilingual_2400_ori_RO3_Batch_8")

model_5 = "mBERT_Mul_2800"
model_5_acc_t, model_5_acc_e = lib.get_model_list("mBERT_Multilingual_2800_ori_RO3_Batch_8")

model_6 = "mBERT_Mul_800"
model_6_acc_t, model_6_acc_e = lib.get_model_list("mBERT_Multilingual_800_ori_RO3_Batch_8")

model_7 = "mBERT_Mul_400"
model_7_acc_t, model_7_acc_e = lib.get_model_list("mBERT_Multilingual_400_ori_RO3_Batch_8")
...
plt.xlabel("Epoch")
plt.ylabel("Accuracy")
plt.title('Accuracy (Training) by Epoch (Tuned by Multilingual)')
#plt.grid(True)
plt.legend()
plt.tight_layout()
#plt.show()

...
# Dataset: pseudo label = std_label
...
# 7.3.1 label
#=======
fileObj = open(var.FILE_NOSAMPLING_ENG_TEXT_DATASET_SLBL, 'wb')
pickle.dump(engdb_txt, fileObj)
fileObj.close()
fileObj = open(var.FILE_NOSAMPLING_ENG_LABEL_DATASET_SLBL, 'wb')
pickle.dump(engdb_label, fileObj)
fileObj.close()

fileObj = open(var.FILE_NOSAMPLING_MULTI_TEXT_DATASET_SLBL, 'wb')
pickle.dump(multiLang_txt, fileObj)
fileObj.close()
fileObj = open(var.FILE_NOSAMPLING_MULTI_LABEL_DATASET_SLBL, 'wb')
pickle.dump(multiLang_label, fileObj)
fileObj.close()

fileObj = open(var.FILE_NOSAMPLING_MULTICOMB_TEXT_DATASET_SLBL, 'wb')
pickle.dump(multiLangComb_txt, fileObj)
fileObj.close()
fileObj = open(var.FILE_NOSAMPLING_MULTICOMB_LABEL_DATASET_SLBL, 'wb')

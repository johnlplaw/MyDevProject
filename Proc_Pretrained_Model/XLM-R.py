...
model = XLMRobertaForSequenceClassification.from_pretrained(model_name, num_labels=3)  # Adjust num_labels for your task
...
torch.save(model.state_dict(), 'trained_xlmr_model.pth')
...
# Save the trained model if needed
torch.save(model.state_dict(), 'xlmr_model.pth')
...
plt.savefig('XLM-R_training_graph.png')

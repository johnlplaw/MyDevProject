...
fileName = var.FILE_NOSAMPLING_MULTICOMB_TEXT_DATASET_SLBL
print(fileName)

isExist = os.path.exists(fileName)
print(isExist)

fileObj = open(var.FILE_NOSAMPLING_MULTICOMB_TEXT_DATASET_SLBL, 'rb')
multi_combined_db_nos_txt_1 = pickle.load(fileObj)
fileObj.close()
fileObj = open(var.FILE_NOSAMPLING_MULTICOMB_LABEL_DATASET_SLBL, 'rb')
...
#for sampling_size in [10]:
    ...
    file_name = var.FILE_MULTICOMB_DF_SLBL + str(sampling_size) + ".obj"

...
# 13. Correct the words
# def spelling_correction(input):
#     input = TextBlob(input)
#     return str(input.correct())

# result = remove_repeated_char("GUN SHOTS!!!!! #Ns10v10  PULL UP THE TUNEEEE")
# print(result)
#

# def clean_by_all_Step(input):
#     txt = removeURL(input)
#     txt = removebStr(txt)
#     txt = removeChar(txt)
#     txt = replaceChar(txt)
#     txt = removeWordStarsWithChar(txt)
#
#     txt = toLowerCase(txt)
#     txt = remove_repeated_char(txt)
#     txt = spelling_correction(txt)
#     return txt
#
# oriTxt = "b'Somebody say mudi3 nkwasias3m saa :face_with_tears_of_joy::face_with_tears_of_joy: https://t.co/N0nVvB5JYB tuneeeeee cute'"
#
# resulTxt = clean_by_all_Step(oriTxt)
#
# print(resulTxt)
